<template>
  <div class="h-screen bg-orangeColor p-3">
    <div
      class="h-full w-full grid grid-cols-1 sm:grid-cols-2 gap-4 place-content-start place-items-center"
    >
      <div class="mx-auto my-12 space-y-12 place-items-start">
        <h1 class="text-whiteColor pl-6 text-4xl md:text-5xl font-black uppercase">
          Susisiek. Patikėk savo projekto rūpesčius mums.
        </h1>
      </div>
      <div class="md:mt-48">
        <div
          class="text-sm space-y-1 text-left w-full place-content-center place-items-center my-8 text-blackLighter"
        >
          <p>UAB “Baltic Display”</p>
          <p>Jūrininkų pr. 2</p>
          <p>LT-95264</p>
          <p>Klaipėda</p>
          <p>Lietuva</p>
        ...
        <button
          ...
          class="mx-auto text-xs w-full p-3 mt-6 rounded-2xl uppercase focus:outline-none bg-orangeColor border border-blackLighter font-bold text-blackLighter transition duration-500 ease-in-out hover:bg-blackLighter hover:text-whiteColor transform hover:-translate-y-1 hover:scale-105"
          type="button"
          name="button"
        >
          parašyk!
